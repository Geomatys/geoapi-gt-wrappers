 ...
 */
class PositionalAccuracyFromGT<S extends org.geotools.api.metadata.quality.PositionalAccuracy>
        extends QualityElementFromGT<S> implements PositionalAccuracy
{
    /**
     ...
     */
    PositionalAccuracyFromGT(final S impl) {
        super(impl);
    }
