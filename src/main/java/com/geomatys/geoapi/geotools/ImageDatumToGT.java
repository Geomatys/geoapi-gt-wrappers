 ...
 */
final class ImageDatumToGT extends DatumToGT<org.opengis.referencing.datum.ImageDatum>
        implements ImageDatum
{
     ...
     */
    ImageDatumToGT(final org.opengis.referencing.datum.ImageDatum impl) {
        super(impl);
    }
