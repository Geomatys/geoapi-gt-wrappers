 ...
 */
class QualityElementFromGT<S extends org.geotools.api.metadata.quality.Element> extends WrapperFromGT implements Element {
    /**
     ...
     */
    QualityElementFromGT(final S impl) {
        this.impl = impl;
    }
