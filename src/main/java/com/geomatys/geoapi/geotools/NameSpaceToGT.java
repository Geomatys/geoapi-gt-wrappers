 ...
 */
final class NameSpaceToGT extends WrapperToGT implements NameSpace {
    /**
     ...
     */
    private NameSpaceToGT(final org.opengis.util.NameSpace impl) {
        this.impl = impl;
    }
    ...
    public GenericName name() {
        return GenericNameToGT.wrap(impl.name());
    }
}
