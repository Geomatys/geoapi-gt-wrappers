 ...
 */
class GeneralParameterValueFromGT<S extends org.geotools.api.parameter.GeneralParameterValue>
        extends WrapperFromGT implements GeneralParameterValue
{
    /**
     ...
     */
    GeneralParameterValueFromGT(final S impl) {
        this.impl = impl;
    }
    ...
    public GeneralParameterDescriptor getDescriptor() {
        return GeneralParameterDescriptorFromGT.wrap(impl.getDescriptor());
    }
