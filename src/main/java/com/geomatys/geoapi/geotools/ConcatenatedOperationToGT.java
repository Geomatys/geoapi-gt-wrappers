 ...
 */
final class ConcatenatedOperationToGT extends CoordinateOperationToGT<org.opengis.referencing.operation.ConcatenatedOperation>
        implements ConcatenatedOperation
{
     ...
     */
    ConcatenatedOperationToGT(final org.opengis.referencing.operation.ConcatenatedOperation impl) {
        super(impl);
    }
    ...
    public List<SingleOperation> getOperations() {
        return wrap(impl.getOperations(), SingleOperationToGT::wrap);
    }
}
